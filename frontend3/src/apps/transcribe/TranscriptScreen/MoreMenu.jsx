...
export function MoreMenu ({ disabled }) {
  ...
  const { mode, recorder, transcriber, playing, transcribeLanguage, partsOrder, createdAt, playbackSpeed } = useSelector(transcribeSelector);
  ...
  async function openSettings () {
    ...
    function onSelectChange (e) {
      ...
      console.log(transcribeLanguage);
            ...
            <div className="w-full flex-col mb-6 mt-2">
              <GroupInput>
                ...
                <div className="flex items-center">
                  <Dropdown onChange={onSelectChange} defaultValue={transcribeLanguage}>
